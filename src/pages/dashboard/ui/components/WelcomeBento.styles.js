...
export const welcomeStyles = {
  ...
  headerContent: { position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', gap: '4px' },
  title: { margin: 0, fontSize: 'clamp(1.25rem, 2.2vw, 1.6rem)', fontWeight: '900', color: COLORS.charcoalBlue, lineHeight: 1.05, letterSpacing: '-0.02em' },
  subtitle: { margin: 0, marginTop: '0px', fontSize: 'clamp(0.88rem, 0.98vw, 0.95rem)', fontWeight: '500', color: COLORS.textSecondary, lineHeight: 1.25 },
